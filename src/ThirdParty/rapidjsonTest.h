...
inline void putValue(rapidjson::Writer<rapidjson::StringBuffer>& writer, const double& msg) {
    writer.Double(msg);
}
...
inline void putValue(rapidjson::Writer<rapidjson::StringBuffer>& writer, const long int& msg) {
    writer.Int64(msg);
}

inline void putValue(rapidjson::Writer<rapidjson::StringBuffer>& writer, const int& msg) {
    writer.Int(msg);
}
...
inline void putValue(rapidjson::Writer<rapidjson::StringBuffer>& writer, const bool& msg) {
    writer.Bool(msg);
}


inline void putValue(rapidjson::Writer<rapidjson::StringBuffer>& writer, const std::vector<long int>& msg) {
    writer.StartArray();
    for (auto& str : msg) {
        writer.Int64(str);
    }
...
inline void getValue(rapidjson::Value& jsonValue, twitter_user_data& data) {
    ...
    getValue(jsonValue["description"], data.description);
    if (jsonValue.HasMember("url"))
        data.url.emplace(jsonValue["url"].GetString());
    ...
    if (jsonValue.HasMember("utc_offset"))
        data.utc_offset.emplace(jsonValue["utc_offset"].GetInt64());
    if (jsonValue.HasMember("time_zone"))
        data.time_zone.emplace(jsonValue["time_zone"].GetString());
    ...
    if (jsonValue.HasMember("profile_banner_url"))
        data.profile_banner_url.emplace(jsonValue["profile_banner_url"].GetString());
...
inline void getValue(rapidjson::Value& jsonValue, status_data& data) {
    ...
    if (jsonValue.HasMember("in_reply_to_status_id"))
        data.in_reply_to_status_id.emplace(jsonValue["in_reply_to_status_id"].GetInt64());
    if (jsonValue.HasMember("in_reply_to_status_id_str"))
        data.in_reply_to_status_id_str.emplace(jsonValue["in_reply_to_status_id_str"].GetString());
    if (jsonValue.HasMember("in_reply_to_user_id"))
        data.in_reply_to_user_id.emplace(jsonValue["in_reply_to_user_id"].GetInt64());
    if (jsonValue.HasMember("in_reply_to_user_id_str"))
        data.in_reply_to_user_id_str.emplace(jsonValue["in_reply_to_user_id_str"].GetString());
    if (jsonValue.HasMember("in_reply_to_screen_name"))
        data.in_reply_to_screen_name.emplace(jsonValue["in_reply_to_screen_name"].GetString());
    ...
    if (jsonValue.HasMember("possibly_sensitive"))
        data.possibly_sensitive.emplace(jsonValue["possibly_sensitive"].GetBool());
}
...
inline void getValue(rapidjson::Value& jsonValue, event& data) {
    ...
    if (jsonValue.HasMember("logo"))
        data.logo = jsonValue["logo"].GetString();
    getValue(jsonValue["name"], data.name);
